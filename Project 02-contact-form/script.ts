let firstNameInput = document.querySelector<HTMLInputElement>("#firstName");

let lastNameInput = document.querySelector<HTMLInputElement>("#lastName");

let emailInput = document.querySelector<HTMLInputElement>("#email");

let messageInput = document.querySelector<HTMLInputElement>("#message");

let generalQueryInput =
  document.querySelector<HTMLInputElement>("#generalEnquiry");

let supportRequestInput =
  document.querySelector<HTMLInputElement>("#supportRequest");

let consentInput = document.querySelector<HTMLInputElement>("#consent");

let fnameErrorEl = document.querySelector<HTMLSpanElement>("#fname-error");

let lnameErrorEl = document.querySelector<HTMLSpanElement>("#lname-error");

let emailErrorEl = document.querySelector<HTMLSpanElement>("#email-error");

let queryErrorEl = document.querySelector<HTMLSpanElement>("#query-error");

let messageErrorEl = document.querySelector<HTMLSpanElement>("#message-error");

let consentErrorEl = document.querySelector<HTMLSpanElement>("#consent-error");

let toastEl = document.querySelector<HTMLDivElement>("#toast");

let formEl = document.querySelector<HTMLFormElement>("form");
...
formEl?.addEventListener("submit", (e) => {
  ...
  let error: boolean = checkError(data);
  if (!error) {
    formEl.reset();
...
function checkError(data: Form): boolean {
  let error = false;
