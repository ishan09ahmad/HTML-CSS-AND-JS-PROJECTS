let plusButtonEl = document.querySelectorAll<HTMLButtonElement>(".plusButton");
let minusButtonEl =
  document.querySelectorAll<HTMLButtonElement>(".minusButton");

let answerEls = document.querySelectorAll<HTMLDivElement>(".answer");

let sunIconEl = document.querySelector<HTMLImageElement>("#sun");
let moonIconEl = document.querySelector<HTMLImageElement>("#moon");

const singleButtonEl = document.querySelector<HTMLButtonElement>("#single")!;
const multipleButtonEl =
  document.querySelector<HTMLButtonElement>("#multiple")!;
